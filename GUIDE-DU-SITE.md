...
| `quisommesnous.html` | **Page de compatibilité — ne pas supprimer.** Elle ne s'affiche nulle part dans le menu. Le QR code « Adhésion » des flyers de la rentrée 2026-2027 pointe vers `apic31.fr/quisommesnous.html`, une adresse de l'ancien blog : cette page reprend la même adresse et redirige vers « Qui sommes-nous », pour que ces QR codes continuent de fonctionner. À conserver tant que ces flyers peuvent circuler. |
